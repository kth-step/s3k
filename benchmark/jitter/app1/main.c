...
tester_t testers[] = {test_get_info,   test_reg_read,	test_reg_write,
		      test_sync,       test_cap_move,	test_cap_delete,
		      test_cap_revoke, test_cap_derive, test_cap_derive_random,
