 ...
 */
void semaphore_init(semaphore_t *sem, uintptr_t tickets);

/**
 * Acquire n tickets and wait for release.
 */
void semaphore_acquire_n(semaphore_t *sem, uintptr_t n);

/**
 * Release n tickets.
 */
void semaphore_release_n(semaphore_t *sem, uintptr_t n);
