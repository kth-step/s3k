...
void aes128_cbc_enc(const uint32_t rk[44], uint8_t iv[16], uint8_t *buf, size_t len);

// Cipher block chaining decryption
void aes128_cbc_dec(const uint32_t rk[44], uint8_t iv[16], uint8_t *buf, size_t len);
