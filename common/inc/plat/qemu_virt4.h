...
#define INIT_CAPS                                                                                                      \
	{                                                                                                              \
		...
		[2] = cap_mk_memory(0x10000000, 0x10001000, MEM_RW), [3] = cap_mk_memory(0x200b000, 0x200c000, MEM_R), \
		[4] = cap_mk_time(0, 0, S3K_SLOT_CNT), [5] = cap_mk_time(1, 0, S3K_SLOT_CNT),                          \
		[6] = cap_mk_time(2, 0, S3K_SLOT_CNT), [7] = cap_mk_time(3, 0, S3K_SLOT_CNT),                          \
